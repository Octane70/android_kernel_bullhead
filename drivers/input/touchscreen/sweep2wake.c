...
struct notifier_block s2w_fb_notif;
...
static int s2w_fb_notifier_callback(struct notifier_block *self,
...
struct notifier_block s2w_fb_notif = {
	.notifier_call = s2w_fb_notifier_callback,
};
